...
import online.shixun.demo.eshop.dto.EshopImgCriteria.Criteria;
import online.shixun.demo.eshop.dto.EshopImgCriteria.Criterion;
import online.shixun.demo.eshop.dto.EshopImgCriteria;
import org.apache.ibatis.jdbc.SQL;

public class EshopImgSqlProvider {
     ...
     */
    public String countByExample(EshopImgCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("eshop_img");
     ...
     * @mbg.generated Fri May 11 10:31:51 CST 2018
     */
    public String deleteByExample(EshopImgCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("eshop_img");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated Fri May 11 10:31:51 CST 2018
     */
    public String insertSelective(EshopImg record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("eshop_img");
        ...
        if (record.getImgIsDef() != null) {
            sql.VALUES("img_is_def", "#{imgIsDef,jdbcType=INTEGER}");
        }
     ...
     * @mbg.generated Fri May 11 10:31:51 CST 2018
     */
    public String selectByExample(EshopImgCriteria example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        EshopImg record = (EshopImg) parameter.get("record");
        EshopImgCriteria example = (EshopImgCriteria) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("eshop_img");
        ...
        if (record.getImgIsDef() != null) {
            sql.SET("img_is_def = #{record.imgIsDef,jdbcType=INTEGER}");
        }
     ...
     * @mbg.generated Fri May 11 10:31:51 CST 2018
     */
    public String updateByPrimaryKeySelective(EshopImg record) {
        SQL sql = new SQL();
        sql.UPDATE("eshop_img");
        ...
        if (record.getImgIsDef() != null) {
            sql.SET("img_is_def = #{imgIsDef,jdbcType=INTEGER}");
        }
     ...
     * @mbg.generated Fri May 11 10:31:51 CST 2018
     */
    protected void applyWhere(SQL sql, EshopImgCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
