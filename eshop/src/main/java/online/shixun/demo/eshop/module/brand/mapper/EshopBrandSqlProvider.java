...
import online.shixun.demo.eshop.dto.EshopBrandCriteria.Criteria;
import online.shixun.demo.eshop.dto.EshopBrandCriteria.Criterion;
import online.shixun.demo.eshop.dto.EshopBrandCriteria;
import org.apache.ibatis.jdbc.SQL;

public class EshopBrandSqlProvider {
     ...
     */
    public String countByExample(EshopBrandCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("eshop_brand");
     ...
     * @mbg.generated Fri May 11 10:31:39 CST 2018
     */
    public String deleteByExample(EshopBrandCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("eshop_brand");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated Fri May 11 10:31:39 CST 2018
     */
    public String insertSelective(EshopBrand record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("eshop_brand");
        ...
        if (record.getBrandDescription() != null) {
            sql.VALUES("brand_description", "#{brandDescription,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated Fri May 11 10:31:39 CST 2018
     */
    public String selectByExample(EshopBrandCriteria example) {
        SQL sql = new SQL();
        ...
        sql.SELECT("brand_description");
        sql.SELECT("brand_logo");
        sql.FROM("eshop_brand");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        EshopBrand record = (EshopBrand) parameter.get("record");
        EshopBrandCriteria example = (EshopBrandCriteria) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("eshop_brand");
        ...
        if (record.getBrandDescription() != null) {
            sql.SET("brand_description = #{record.brandDescription,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated Fri May 11 10:31:39 CST 2018
     */
    public String updateByPrimaryKeySelective(EshopBrand record) {
        SQL sql = new SQL();
        sql.UPDATE("eshop_brand");
        ...
        if (record.getBrandDescription() != null) {
            sql.SET("brand_description = #{brandDescription,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated Fri May 11 10:31:39 CST 2018
     */
    protected void applyWhere(SQL sql, EshopBrandCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
